    ...
    def upload_image(self):
        ...
        if file_path:
            try:
                ...
                from roboflow import Roboflow
                rf = Roboflow(api_key="wQoxcxmIzTd2kxSCzB1s")
                ...
                # YOLO MODEL
                rf = Roboflow(api_key="wmxXRYGBagkhHD65iN7X")
                project = rf.workspace("obj-90l5l").project("image-to-blog")
                ...
                # OPENAI API
                openai.organization = "org-9eKJ2vB0ByX6CueOPjSoUSTq"
                openai.api_key = "sk-proj-om6hnyGWh01UJRFmWg5QT3BlbkFJzbkVuY3OaQ1rIQfFARpX"
